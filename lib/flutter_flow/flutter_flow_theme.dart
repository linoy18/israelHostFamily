...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF0660A8);
  late Color tertiary = const Color(0xFFFFFFFF);
  late Color alternate = const Color(0xFFDADADA);
  ...
  late Color turquoise = Color(0xFF0748A2);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color tertiary = const Color(0xFFFFFFFF);
  late Color alternate = const Color(0xFF0D0E0E);
  ...
  late Color redApple = Color(0xFFFC4253);
  late Color celadon = Color(0xFF96E6B3);
  late Color turquoise = Color(0xFF6EACFF);
  late Color gunmetal = Color(0xFF262D34);
  late Color grayIcon = Color(0xFF95A1AC);
