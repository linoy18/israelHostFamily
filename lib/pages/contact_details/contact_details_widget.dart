  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> contactDetailsUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final contactDetailsUsersRecord =
            contactDetailsUsersRecordList.isNotEmpty
                ? contactDetailsUsersRecordList.first
                : null;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).secondaryBackground,
              ...
              children: [
                Container(
                  ...
                  child: Column(
                    mainAxisSize: MainAxisSize.max,
                    children: [
                      if (contactDetailsUsersRecord?.photoUrl != null &&
                      ...
                      if (contactDetailsUsersRecord?.email != null &&
                          contactDetailsUsersRecord?.email != '')
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              10.0, 10.0, 10.0, 10.0),
                          child: Row(
                      ...
                      if (contactDetailsUsersRecord?.bio != null &&
                          contactDetailsUsersRecord?.bio != '')
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              10.0, 10.0, 10.0, 10.0),
                          child: Row(
                      ...
                      if (contactDetailsUsersRecord?.instagramUserName !=
                              null &&
                          contactDetailsUsersRecord?.instagramUserName != '')
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              10.0, 10.0, 10.0, 10.0),
                          child: InkWell(
                            ...
                            onTap: () async {
                              await Clipboard.setData(ClipboardData(
                                  text: contactDetailsUsersRecord!
                                      .instagramUserName));
                            },
                            child: Row(
                              mainAxisSize: MainAxisSize.max,
