  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<PropertiesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        final searchPropertiesPropertiesRecord =
            searchPropertiesPropertiesRecordList.isNotEmpty
                ? searchPropertiesPropertiesRecordList.first
                : null;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).primaryBackground,
                        ...
                        builder: (context) {
                          ...
                          return ListView.builder(
                            ...
                            itemBuilder: (context, propSearchIndex) {
                              final propSearchItem =
                                  propSearch[propSearchIndex];
                              return Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    16.0, 0.0, 16.0, 12.0),
                                child: Container(
